...
void Bank::update(){
    cout<<"Enter id of customer those data you want to update: "<<endl;
    cin>>id;
    for(int i=0;i<total;i++){
        if(id==person[i].ID){
...
void Bank::search(){
    cout<<"Enter id of customer those data you want to search: "<<endl;
    cin>>id;
    for(int i=0;i<total;i++){
        if(id==person[i].ID){
            cout<<"Name: "<<person[i].name<<endl;
...
void Bank::transactions(){
    int cash;
    char ch;
    cout<<"Enter id of customer those data you want to transaction: "<<endl;
    cin>>id;
    for(int i=0;i<total;i++){
        if(id==person[i].ID){
            cout<<"Name: "<<person[i].name<<endl;
...
void Bank::del(){
    ...
    switch(ch){
        case '1':
            cout<<"Enter id of customer those data you want to delete"<<endl;
            cin>>id;
            for(int i=0;i<total;i++){
                if(id==person[i].ID){
